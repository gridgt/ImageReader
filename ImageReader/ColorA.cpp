...
ColorA::ColorA(const std::uint8_t& a, const std::uint8_t& r, const std::uint8_t& g, const std::uint8_t& b):
	a{ a }, r{ r }, g{ g }, b{ b }
{

}
ColorA::ColorA(const uint32_t& rgba)
{
	r = (rgba >> 24) & 0xFF;
	g = (rgba >> 16) & 0xFF;
	b = (rgba >> 8) & 0xFF;
...
ColorA::ColorA(const std::string& rgbaStr)
{
...
ColorA::ColorA(const std::wstring& rgbaStr)
{
...
bool ColorA::isTransparent() const
{
	return a == 0;
}
bool ColorA::equals(const ColorA& other) const
{
	return (r == other.r && g == other.g && b == other.b && a == other.a);
}
void ColorA::setRGBA(const int& r, const int& g, const int& b, const int& a)
{
	this->r = r;
	this->b = b;
	this->g = g;
...
std::uint8_t ColorA::getA() const
{
	return a;
}
std::uint8_t ColorA::getR() const
{
	return r;
}
std::uint8_t ColorA::getG() const
{
	return g;
}
std::uint8_t ColorA::getB() const
{
	return b;
}

winrt::Windows::UI::Color ColorA::getUIColor() const
{
	return ColorHelper::FromArgb(a, r, g,b);
}

D2D1_COLOR_F ColorA::getD2DColor() const
{
